  ...
  })(
    {
      ...
      2: [
        function (require, module, exports) {
          ...
          CompositeRectTileLayer.prototype = Object.create(
            PIXI.Container.prototype
          );
          CompositeRectTileLayer.prototype.constructor = RectTileLayer;
          CompositeRectTileLayer.prototype.updateTransform =
            CompositeRectTileLayer.prototype.displayObjectUpdateTransform;

          //can be initialized multiple times
          CompositeRectTileLayer.prototype.initialize = function (
            zIndex,
            bitmaps,
            useSquare,
            texPerChild
          ...
          CompositeRectTileLayer.prototype.setBitmaps = function (bitmaps) {
            ...
            var i;
            for (i = 0; i < len1; i++) {
              this.children[i].textures = bitmaps.slice(
                i * texPerChild,
                (i + 1) * texPerChild
              );
            }
          ...
          CompositeRectTileLayer.prototype.renderWebGL = function (renderer) {
            ...
            renderer._activeRenderTarget.projectionMatrix
              .copy(this._globalMat)
            ...
            if (this.useSquare) {
              ...
              shader.uniforms.projectionScale =
                Math.abs(this.worldTransform.a) * renderer.resolution;
            }
            var af = (shader.uniforms.animationFrame =
              renderer.plugins.tile.tileAnim);
      ...
      3: [
        function (require, module, exports) {
          ...
          GraphicsLayer.prototype.renderWebGL = function (renderer) {
            if (!this._webGL[renderer.gl.id]) this.dirty = true;
      ...
      4: [
        function (require, module, exports) {
          ...
          RectTileLayer.prototype.addRect = function (
            textureId,
            u,
            v,
            x,
      ...
      7: [
        function (require, module, exports) {
          ...
          TileRenderer.prototype.createVb = function (useSquare) {
            ...
            var gl = this.renderer.gl;
            var vb = PIXI.glCore.GLBuffer.createVertexBuffer(
              gl,
              null,
              gl.STREAM_DRAW
            );
        ...
        { "./RectTileShader": 5, "./SquareTileShader": 6 },
      ],
      8: [
        function (require, module, exports) {
          function ZLayer() {
          ...
          ZLayer.prototype.cacheIfDirty = function () {
            ...
            if (!buf) {
              ...
              tempRender = this._tempRender = new PIXI.CanvasRenderer(
                100,
                100,
                { view: buf }
              );
      ...
      10: [
        ...
        {
          "./CanvasTileRenderer": 1,
          "./CompositeRectTileLayer": 2,
          "./GraphicsLayer": 3,
          "./RectTileLayer": 4,
          "./TileRenderer": 7,
          "./ZLayer": 8,
