  ...
  })(
    {
      ...
      4: [
        function (require, module, exports) {
          ...
          PictureRenderer.prototype = Object.create(
          ...
          PictureRenderer.prototype.onContextChange = function () {
            ...
            this.normalShader = [
              new NormalShader(gl, 0),
              new NormalShader(gl, 1),
              new NormalShader(gl, 2),
            ];
          ...
          PictureRenderer.prototype._renderSprite = function (sprite, shader) {
            ...
            var vd = sprite.computedGeometry
        ...
        { "./NormalShader": 2, "./mapFilterBlendModesToPixi": 8 },
      ],
      5: [
        function (require, module, exports) {
          /**
      ...
      7: [
        function (require, module, exports) {
          ...
          PictureTilingSprite.prototype = Object.create(
      ...
      8: [
        function (require, module, exports) {
          ...
          function mapFilterBlendModesToPixi(gl, array) {
            ...
            array[CONST.BLEND_MODES.OVERLAY] = [
              new OverlayShader(gl, 0),
              new OverlayShader(gl, 1),
              new OverlayShader(gl, 2),
            ];
            array[CONST.BLEND_MODES.HARD_LIGHT] = [
              new HardLightShader(gl, 0),
              new HardLightShader(gl, 1),
              new HardLightShader(gl, 2),
            ];
        ...
        { "./HardLightShader": 1, "./OverlayShader": 3 },
      ],
      9: [
        function (require, module, exports) {
          var myPlugin = {
