...
if (Imported.FTKR_STS) {
  ...
  FTKR.STS.CW.alwaysDispCost = Number(
    FTKR.STS.CW.parameters["Always Display Cost"] || 0
  );
  FTKR.STS.CW.alwaysDispPreskill = Number(
    FTKR.STS.CW.parameters["Always Display Preskill"] || 0
  );
  ...
  Window_Base.prototype.setWubdiwLayout = function (layout) {
    ...
    this.y = layout.posiY;
    this.width =
      layout.width === -1 ? Graphics.boxWidth - this.x : layout.width;
    this.height =
      layout.height === -1 ? Graphics.boxHeight - this.y : layout.height;
  };
  ...
  Window_Base.prototype.getWindowLayout = function (layout) {
    return {
      ...
      y: layout.posiY,
      width:
        layout.width === -1 ? Graphics.boxWidth - layout.posiX : layout.width,
      height:
        layout.height === -1
          ? Graphics.boxHeight - layout.posiY
          : layout.height,
    };
  };
  ...
  Window_TreeType.prototype.initialize = function (x, y, width, height) {
    ...
    FTKR.STS.CW.Window_TreeType_initialize.call(
      this,
      layout.x,
      layout.y,
      layout.width,
  ...
  FTKR.STS.CW.Window_SkillTree_initialize =
    Window_SkillTree.prototype.initialize;
  Window_SkillTree.prototype.initialize = function (x, y, width, height) {
    var layout = this.getWindowLayout(FTKR.STS.CW.skillTree);
    FTKR.STS.CW.Window_SkillTree_initialize.call(
      this,
      layout.x,
      layout.y,
      layout.width,
  ...
  FTKR.STS.CW.Window_StsSkillStatus_initialize =
    Window_StsSkillStatus.prototype.initialize;
  Window_StsSkillStatus.prototype.initialize = function (x, y, width, height) {
    ...
    FTKR.STS.CW.Window_StsSkillStatus_initialize.call(
      this,
      layout.x,
      layout.y,
      layout.width,
  ...
  Window_StsSkillStatus.prototype._refreshFrame = function () {
    if (!FTKR.STS.CW.skillStatus.frame)
  ...
  FTKR.STS.CW.Window_StsActorStatus_initialize =
    Window_StsActorStatus.prototype.initialize;
  Window_StsActorStatus.prototype.initialize = function (x, y, width, height) {
    ...
    FTKR.STS.CW.Window_StsActorStatus_initialize.call(
      this,
      layout.x,
      layout.y,
      layout.width,
  ...
  Window_StsActorStatus.prototype._refreshFrame = function () {
    if (!FTKR.STS.CW.actorStatus.frame)
      Window.prototype._refreshFrame.call(this);
  };
  ...
  Window_StsCost.prototype.initialize = function (x, y, width, height) {
    ...
    FTKR.STS.CW.Window_StsCost_initialize.call(
      this,
      layout.x,
      layout.y,
      layout.width,
  ...
  FTKR.STS.CW.Window_StsPreskill_initialize =
    Window_StsPreskill.prototype.initialize;
  Window_StsPreskill.prototype.initialize = function (x, y, width, height) {
    var layout = this.getWindowLayout(FTKR.STS.CW.preskill);
    FTKR.STS.CW.Window_StsPreskill_initialize.call(
      this,
      layout.x,
      layout.y,
      layout.width,
  ...
  FTKR.STS.CW.Window_StsConfTitle_initialize =
    Window_StsConfTitle.prototype.initialize;
  Window_StsConfTitle.prototype.initialize = function (x, y, width, height) {
    var layout = this.getWindowLayout(FTKR.STS.CW.confTitle);
    FTKR.STS.CW.Window_StsConfTitle_initialize.call(
      this,
      layout.x,
      layout.y,
      layout.width,
