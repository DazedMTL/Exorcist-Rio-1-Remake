...
(function () {
  ...
  var paramFontSizeRange = getParamNumber(
    ["FontSizeRange", "フォントサイズ増減幅"],
    0
  );
  var paramFontUpperLimit = getParamNumber(
    ["FontUpperLimit", "フォントサイズ上限"],
    0
  );
  var paramFontLowerLimit = getParamNumber(
    ["FontLowerLimit", "フォントサイズ下限"],
    0
  );
  ...
  Game_Interpreter.prototype.pluginCommandMessageWindowPopup = function (
    command,
    args
  ) {
    switch (getCommandName(command)) {
        ...
        switch (getCommandName(args[0])) {
          ...
          case "位置_上固定":
            $gameSystem.setPopupFixUpper(
              args[1] ? this.getEventIdForMessagePopup(args[1]) : null
            );
            break;
          case "POS_LOWER":
          case "位置_下固定":
      ...
      case "フキダシウィンドウ調整":
        switch (getCommandName(args[0])) {
          ...
          case "POS":
          case "位置":
            $gameSystem.setPopupAdjustPosition(
              getArgNumber(args[1]),
              getArgNumber(args[2])
            );
            break;
  ...
  Game_Interpreter.prototype.getEventIdForMessagePopup = function (arg) {
    ...
    if (eventId === 0) {
      eventId =
        this.eventId() ||
        ($gameMap.isEventRunning() ? $gameMap._interpreter.eventId() : 0);
    }
    return eventId;
  };
  ...
  Game_System.prototype.getMessagePopupId = function () {
    return this._messagePopupCharacterId !== 0
      ? this._messagePopupCharacterId
      : null;
  };
  ...
  Game_System.prototype.isPopupFixPosition = function (position) {
    this.initMessagePositionEvents();
    var positionFixForId =
      this._messagePopupPositionEvents[this._messagePopupCharacterId];
    var event = $gameMap.event(this._messagePopupCharacterId);
    var positionFixForName = event
      ? this._messagePopupPositionEvents[event.event().name]
      : 0;
  ...
  //  イベント起動時に自動設定を適用します。
  //=============================================================================
  var _Game_Map_setupStartingMapEvent =
    Game_Map.prototype.setupStartingMapEvent;
  ...
  Game_CharacterBase.prototype.setSizeForMessagePopup = function (
    width,
    height
  ) {
  ...
  Window_Base.prototype.isPopupLower = function () {
    return (
      $gameSystem.isPopupFixLower() ||
      (!$gameSystem.isPopupFixUpper() && this.y < 0)
    );
  };
  ...
  Window_Base.prototype.setPopupPosition = function (character) {
    ...
    this.y =
      character.getRealScreenY() -
      this.height -
      (character.getHeightForPopup() + 8) +
      (pos ? pos[1] : 0);
  ...
  Window_Base.prototype.updatePlacementPopup = function () {
    ...
    if (paramLinkage) {
      ...
      this.y =
        Graphics.boxHeight -
        this.height -
        this._messageWindow.windowHeight() / 2;
    }
  };
  ...
  //=============================================================================
  Window_Message._faceHeight = Math.floor(
    (Window_Base._faceHeight * paramFaceScale) / 100
  );
  Window_Message._faceWidth = Math.floor(
    (Window_Base._faceWidth * paramFaceScale) / 100
  );

  var _Window_Message_standardFontSize =
    Window_Message.prototype.standardFontSize;
  Window_Message.prototype.standardFontSize = function () {
    return this.isPopup()
      ? paramFontSize
      : _Window_Message_standardFontSize.apply(this, arguments);
  };

  var _Window_Message_standardPadding =
    Window_Message.prototype.standardPadding;
  Window_Message.prototype.standardPadding = function () {
    return this.isPopup()
      ? paramPadding
      : _Window_Message_standardPadding.apply(this, arguments);
  };
  ...
  Window_Message.prototype.isPopupLower = function () {
    return (
      $gameSystem.isPopupFixLower() ||
      (!$gameSystem.isPopupFixUpper() && this.getWindowTopY() < 0)
    );
  };
  ...
  Window_Message.prototype.getWindowTopY = function () {
    return (
      this.y -
      (this._nameWindow && this._nameWindow.visible
  ...
  Window_Message.prototype.updatePlacementPopup = function () {
    ...
    if (
      this._nameWindow &&
      checkTypeFunction(this._nameWindow.updatePlacementPopup)
    ) {
  ...
  Window_Message.prototype.processVirtual = function () {
    ...
    if (choices && $gameSystem.getPopupSubWindowPosition() === 2) {
      ...
      virtual.maxWidth = Math.max(
        virtual.maxWidth,
        this.newLineX() + this._choiceWindow.maxChoiceWidth()
      );
    }
  ...
  Window_Message.prototype.processVirtualCharacter = function (textState) {
    switch (textState.text[textState.index]) {
      ...
      case "\f":
        ...
        break;
      case "\x1b":
        this.processVirtualEscapeCharacter(
  ...
  Window_Message.prototype.processVirtualEscapeCharacter = function (
    code,
    textState
  ) {
    switch (code) {
  ...
  Window_Message.prototype.processVirtualNormalCharacter = function (
    textState
  ) {
  ...
  Window_Message.prototype.processVirtualDrawIcon = function (
    iconIndex,
    textState
  ) {
  ...
  Window_Message.prototype.drawFace = function (
    ...
    if (this.isPopup()) {
      ...
      this.contents.blt(
        ...
        dx,
        dy,
        Window_Message._faceWidth,
        Window_Message._faceHeight
      );
    } else {
  ...
  //=============================================================================
  var _Window_ChoiceList_standardFontSize =
    Window_ChoiceList.prototype.standardFontSize;
  Window_ChoiceList.prototype.standardFontSize = function () {
    return this.isPopupLinkage()
      ? paramFontSize
      : _Window_ChoiceList_standardFontSize.apply(this, arguments);
  };

  var _Window_ChoiceList_standardPadding =
    Window_ChoiceList.prototype.standardPadding;
  Window_ChoiceList.prototype.standardPadding = function () {
    return this.isPopupLinkage()
      ? paramPadding
      : _Window_ChoiceList_standardPadding.apply(this, arguments);
  };
  ...
  Window_ChoiceList.prototype.lineHeight = function () {
    return this.isPopupLinkage()
      ? paramFontSize + 8
      : _Window_ChoiceList_lineHeight.apply(this, arguments);
  };
  ...
  var _Window_ChoiceList_numVisibleRows =
  ...
  //  ポップアップする場合、メッセージウィンドウに連動して表示位置と余白を調整します。
  //=============================================================================
  var _Window_NumberInput_standardFontSize =
    Window_NumberInput.prototype.standardFontSize;
  Window_NumberInput.prototype.standardFontSize = function () {
    return this.isPopupLinkage()
      ? paramFontSize
      : _Window_NumberInput_standardFontSize.apply(this, arguments);
  };

  var _Window_NumberInput_standardPadding =
    Window_NumberInput.prototype.standardPadding;
  Window_NumberInput.prototype.standardPadding = function () {
    return this.isPopupLinkage()
      ? paramPadding
      : _Window_NumberInput_standardPadding.apply(this, arguments);
  };
  ...
  Window_NumberInput.prototype.lineHeight = function () {
    return this.isPopupLinkage()
      ? paramFontSize + 8
      : _Window_NumberInput_lineHeight.apply(this, arguments);
  };
  ...
  if (typeof Window_NameBox !== "undefined") {
    var _Window_NameBox_standardFontSize =
      Window_NameBox.prototype.standardFontSize;
    Window_NameBox.prototype.standardFontSize = function () {
      return this.isPopupLinkage()
        ? paramFontSize
        : _Window_NameBox_standardFontSize.apply(this, arguments);
    };

    var _Window_NameBox_standardPadding =
      Window_NameBox.prototype.standardPadding;
    Window_NameBox.prototype.standardPadding = function () {
      return this.isPopupLinkage()
        ? paramPadding
        : _Window_NameBox_standardPadding.apply(this, arguments);
    };
    ...
    Window_NameBox.prototype.lineHeight = function () {
      return this.isPopupLinkage()
        ? paramFontSize + 8
        : _Window_NameBox_lineHeight.apply(this, arguments);
    };

    var _Window_NameBox_updatePlacement =
  ...
  if (imported_FTKR_EMW()) {
    ...
    var _EMW_Game_System_clearMessagePopup =
      Game_System.prototype.clearMessagePopup;
    Game_System.prototype.clearMessagePopup = function () {
    ...
    Game_System.prototype.getMessagePopupIdEx = function (windowId) {
      windowId = windowId || 0;
      return this._messagePopupCharacterIds[windowId] !== 0
        ? this._messagePopupCharacterIds[windowId]
        : null;
    };
    ...
    //Window_MessageEx
    //------------------------------------------------------------------------
    var _Window_MessageEx_startMessage =
      Window_MessageEx.prototype.startMessage;
    ...
    var _Window_MessageEx_updatePlacement =
      Window_MessageEx.prototype.updatePlacement;
    ...
    Window_MessageEx.prototype.newLineX = function () {
      if (this.isPopup()) {
        return this._gameMessage.faceName() === ""
          ? 0
          : Window_Message._faceWidth + 8;
      } else {
    ...
    //Window_ChoiceListEx
    //------------------------------------------------------------------------
    var _Window_ChoiceListEx_numVisibleRows =
      Window_ChoiceListEx.prototype.numVisibleRows;
    ...
    var _Window_ChoiceListEx_updatePlacement =
      Window_ChoiceListEx.prototype.updatePlacement;
    ...
    //------------------------------------------------------------------------
    var _Window_NumberInputEx_updatePlacement =
      Window_NumberInputEx.prototype.updatePlacement;
