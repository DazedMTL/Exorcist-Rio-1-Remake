...
(function () {
  ...
  Game_Interpreter.prototype.pluginCommand = function (command, args) {
    ...
    if (typeof command != "undefined") {
      ...
      if (
        ...
        var isValidColor1 = /(^#[0-9A-F]{6}$)|(^#[0-9A-F]{3}$)/i.test(
          tilecolor
        );
        if (!isValidColor1) {
        ...
        if (args[0] === "tint") {
          if (args.length == 7) {
            ...
            for (var i = 0; i <= 5; i++) {
              ...
              var isValidColor3 = /(^#[0-9A-F]{6}$)|(^#[0-9A-F]{3}$)/i.test(
                tintcolor
              );
      ...
      if (command === "daynight") {
        ...
        if (args[0] === "color") {
          ...
          var isValidColor = /(^#[0-9A-F]{6}$)|(^#[0-9A-F]{3}$)/i.test(
            hourcolor
          );
          if (isValidColor) {
      ...
      if (command === "flashlight") {
        if (args[0] == "on") {
          ...
          if (args.length >= 3) {
            playercolor = args[3];
            var isValidPlayerColor = /(^#[0-9A-F]{6}$)|(^#[0-9A-F]{3}$)/i.test(
              playercolor
            );
      ...
      if ($gameMap.events()[i]) {
        if ($gameMap.events()[i].event()) {
          ...
          if (
            note_command == "light" ||
            note_command == "fire" ||
            note_command == "flashlight" ||
            note_command == "daynight"
          ) {
            ...
            event_moving.push(
              $gameMap.events()[i]._moveType ||
                $gameMap.events()[i]._moveRouteForcing
            );
        ...
        if ($gameVariables.GetScriptActive() == true && $gameMap.mapId() >= 0) {
          ...
          if ($gameVariables.GetMog() == true) {
            if (searchdaynight.search("mogtime") >= 0) {
              ...
              if (debugline == "") {
                debugline =
                  "No switches (21-26) active, Mog is probably not loaded";
              }
          ...
          if (darkenscreen == true) {
            ...
            if (daynightspeed > 0 && daynightspeed < 5000) {
              ...
              if (seconds > oldseconds) {
                ...
                var daynightminutes = Math.floor(daynighttimer / daynightspeed);
                var daynighttimeover =
                  daynighttimer - daynightspeed * daynightminutes;
                var daynightseconds = Math.floor(
                  (daynighttimeover / daynightspeed) * 60
                );
              ...
              if (settings) {
                if (settings != "undefined") {
                  ...
                  if (setstring.length > 2) {
                    // SPECIALS  FADE/GROW ETC.

                    if (
                      lightset[3] == "FADEIN" ||
                      lightset[3] == "FADEINOUT" ||
                      lightset[3] == "BIO"
                    ) {
                    ...
                    if (lightset[3] == "FADEOUT") {
                      ...
                      if (
                        Terrax_ABS_blast_fade[i] == -1 &&
                        Terrax_ABS_blast_duration[i] < fadelength
                      ) {
                        // start fading when blastduration equals fadelength
                        Terrax_ABS_blast_fade[i] = 0;
                      }
                      if (
                        Terrax_ABS_blast_fade[i] < fadelength &&
                        Terrax_ABS_blast_fade[i] >= 0
                      ) {
                        Terrax_ABS_blast_fade[i] = Terrax_ABS_blast_fade[i] + 1;
                    ...
                    if (lightset[3] == "FADEINOUT" || lightset[3] == "BIO") {
                      ...
                      var fadelength = Number(lightset[4]); // number of frames to fade out
                      if (
                        Terrax_ABS_blast_fade[i] == 100000 &&
                        Terrax_ABS_blast_duration[i] < fadelength
                      ) {
                        // start fading when blastduration equals fadelength
                      ...
                      if (
                        Terrax_ABS_blast_fade[i] - 100000 < fadelength &&
                        Terrax_ABS_blast_fade[i] > 100000
                      ) {
                        Terrax_ABS_blast_fade[i] = Terrax_ABS_blast_fade[i] + 1;
                        //Graphics.Debug('FADEOUT',Terrax_ABS_blast_fade[i]);
                    ...
                    if (
                      ...
                      if (Terrax_ABS_blast_grow[i] < growlength) {
                        if (lightset[3] == "BIO") {
                          Terrax_ABS_blast_grow[i] =
                            Terrax_ABS_blast_grow[i] + 0.5;
                        } else {
                          Terrax_ABS_blast_grow[i] =
                            Terrax_ABS_blast_grow[i] + 1;
                        }
                    ...
                    if (lightset[3] == "SHRINK") {
                      ...
                      if (
                        Terrax_ABS_blast_grow[i] == -1 &&
                        Terrax_ABS_blast_duration[i] < shrinklength
                      ) {
                        Terrax_ABS_blast_grow[i] = 0;
                      }
                      if (
                        Terrax_ABS_blast_grow[i] < shrinklength &&
                        Terrax_ABS_blast_grow[i] >= 0
                      ) {
                        ...
                        fradius =
                          Number(lightset[0]) - Math.floor(step * radiuscount);
                      }
                    }
                    ...
                    if (lightset[3] == "GROWSHRINK") {
                      ...
                      if (
                        Terrax_ABS_blast_grow[i] - 100000 < shrinklength &&
                        Terrax_ABS_blast_grow[i] > 100000
                      ) {
                        Terrax_ABS_blast_grow[i] = Terrax_ABS_blast_grow[i] + 1;
              ...
              if (
                ...
                if (light_radius >= 0) {
                  ...
                  if (colorvalue == "cycle" && evid < 1000) {
                    ...
                    var isValidColor =
                      /(^#[0-9A-F]{6}$)|(^#[0-9A-F]{3}$)/i.test(colorvalue);
                    if (!isValidColor) {
                      colorvalue = "#FFFFFF";
                    }
                  }
  ...
  Bitmap.prototype.FillCircle = function (
    ...
    for (var i = start_angle * Math.PI; i < end_angle * Math.PI; i += 0.01) {
      xPos =
        centerX -
        yradius * Math.sin(i) * Math.sin(rotation * Math.PI) +
        xradius * Math.cos(i) * Math.cos(rotation * Math.PI);
      yPos =
        centerY +
        xradius * Math.cos(i) * Math.sin(rotation * Math.PI) +
        yradius * Math.sin(i) * Math.cos(rotation * Math.PI);
  ...
  Bitmap.prototype.radialgradientFillRect2 = function (
    x1,
    y1,
    r1,
    r2,
  ...
  var Window_Options_addGeneralOptions =
