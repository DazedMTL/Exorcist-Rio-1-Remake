...
Kath.Param.PartyDeathCommonEventID = Number.parseInt(
  Kath.Parameters["Party Death Common Event ID"]
);
Kath.Param.ShowGameOverScene = Kath.Core.parseBoolean(
  Kath.Parameters["Show Game Over Scene"],
  true
);
Kath.Param.ReloadLastSave = Kath.Core.parseBoolean(
  Kath.Parameters["Reload Last Save"],
  false
);
Kath.Param.AfterGameOverCommonEventID = Number.parseInt(
  Kath.Parameters["After Game Over Common Event ID"]
);
