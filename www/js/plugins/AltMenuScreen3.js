...
(function () {
  ...
  Window_MenuStatus.prototype.windowHeight = function () {
    ...
    return Graphics.boxHeight - h1 - h2 + 70;
  };
  ...
  Window_MenuStatus.prototype.drawItemImage = function (index) {
    ...
    if (bitmap) {
      ...
      // when bitmap is not set, do the original process.
  ...
  Window_MenuStatus.prototype.drawItemStatus = function (index) {
    ...
    var lineHeight = this.lineHeight();
    this.drawActorName(actor, x, y + lineHeight * 0.5, width);
    this.drawActorLevel(actor, x, y + lineHeight * 1.5, width);
    this.drawActorClass(actor, x + 150, y + lineHeight * 0.5, width);
    this.drawActorHp(actor, x, y + lineHeight * 3.5, width / 2);
    this.drawActorMp(actor, x, y + lineHeight * 4.5, width / 2);
    this.drawActorTp(actor, x, y + lineHeight * 2.5, width / 4);
    this.drawActorIcons(actor, x, bottom - lineHeight * 1, width);
  };
