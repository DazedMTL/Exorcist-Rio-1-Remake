...
(function () {
  ...
  Game_Map.prototype.xWithDirection = function (x, d) {
    if (localHalfPositionCount > 0) {
      return (
        x + (d === 6 ? Game_Map.tileUnit : d === 4 ? -Game_Map.tileUnit : 0)
      );
    } else {
  ...
  Game_Map.prototype.yWithDirection = function (y, d) {
    if (localHalfPositionCount > 0) {
      return (
        y + (d === 2 ? Game_Map.tileUnit : d === 8 ? -Game_Map.tileUnit : 0)
      );
    } else {
  ...
  Game_Map.prototype.isUpperNp = function (x, y) {
    return (
      this.isIncludeTerrainTag(x, y, paramUpperNpTerrainTag) ||
  ...
  Game_Map.prototype.isLowerNp = function (x, y) {
    return (
      this.isIncludeTerrainTag(x, y, paramLowerNpTerrainTag) ||
  ...
  Game_Map.prototype.isRightNp = function (x, y) {
    return (
      this.isIncludeTerrainTag(x, y, paramRightNpTerrainTag) ||
  ...
  Game_Map.prototype.isLeftNp = function (x, y) {
    return (
      this.isIncludeTerrainTag(x, y, paramLeftNpTerrainTag) ||
  ...
  Game_Map.prototype.isAllNp = function (x, y) {
    return (
      this.isIncludeTerrainTag(x, y, paramAllNpTerrainTag) ||
  ...
  Game_CharacterBase.prototype.isMapPassable = function (x, y, d) {
    ...
    if (this.isHalfMove()) {
      result =
        result &&
        !this.isUpperNoPassable(x, y, d) &&
        !this.isLowerNoPassable(x, y, d) &&
        !this.isRightNoPassable(x, y, d) &&
        !this.isLeftNoPassable(x, y, d) &&
        !this.isAllNoPassable(x, y, d);
    }
    ...
    if (d === 8) {
      if (!this.isHalfPosY(y)) {
        if (this.isHalfPosX(x)) {
          ...
          var xRight1 = $gameMap.roundHalfXWithDirection(x, 6);
          result =
            $gameMap.isUpperNp(xLeft1, y) || $gameMap.isUpperNp(xRight1, y);
        } else {
      ...
      if (!this.isHalfPosY(y)) {
        if (this.isHalfPosX(x)) {
          ...
          var xRight2 = $gameMap.roundHalfXWithDirection(x, 6);
          result =
            $gameMap.isUpperNp(xLeft2, y2) || $gameMap.isUpperNp(xRight2, y2);
        } else {
    ...
    if (d === 8) {
      if (!this.isHalfPosY(y)) {
        if (this.isHalfPosX(x)) {
          ...
          var xRight1 = $gameMap.roundHalfXWithDirection(x, 6);
          result =
            $gameMap.isLowerNp(xLeft1, y) || $gameMap.isLowerNp(xRight1, y);
        } else {
      ...
      if (this.isHalfPosY(y)) {
        ...
        if (this.isHalfPosX(x)) {
          ...
          var xRight2 = $gameMap.roundHalfXWithDirection(x, 6);
          result =
            $gameMap.isLowerNp(xLeft2, y2) || $gameMap.isLowerNp(xRight2, y2);
        } else {
  ...
  Game_CharacterBase.prototype.isRightNoPassable = function (x, y, d) {
    ...
    if ((d === 4 && !this.isHalfPosX(x)) || (d === 6 && this.isHalfPosX(x))) {
      ...
      (d === 2 && !this.isHalfPosY(y)) ||
      (d === 8 && this.isHalfPosY(y))
    ) {
