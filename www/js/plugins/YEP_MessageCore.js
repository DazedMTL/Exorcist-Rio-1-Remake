...
//=============================================================================
/*:
 * @plugindesc v1.11 Adds more features to the Message Window to customized
...
/*:ja
 * @plugindesc v1.11 メッセージの表示方法や機能をカスタマイズすることができます。
 * @author Yanfly Engine Plugins
 *
 * @param ---一般---
 * @default
 ...
 *
 * @param Font Outline
 * @desc アウトラインフォントに使われるデフォルトの横幅を指定します。
 * Default: 4
 * @default 4
 *
 * @param ---Name Box---
 ...
 *
 * @param Name Box Added Text
 * @desc ネームボックスが使われる際には必ずこのテキストが追加されます。
 * 自動的にカラー設定をしたい場合などに使われます。
 * @default \c[6]
 *
 * @help
 * ============================================================================
 ...
 *
 *   EnableWordWrap
 *   - ワードラップを有効にします。文がウィンドウサイズ
 *     を超えてしまった時に、自動的に次の行に進みます
 *     改行する際は '\br'を挿入してください。
 *
 *   DisableWordWrap
 *   - ワードラップを無効にします。エディタ内で新しい文
 *     が始まった地点で、自動的に改行されます。
 *
 *   EnableFastForward
 *   - メッセージ内の早送りキーを有効にします。
...
Window_Base.prototype.processEscapeCharacter = function (code, textState) {
  switch (code) {
    ...
    case "PY":
      ...
      break;
    default:
      Yanfly.Message.Window_Base_processEscapeCharacter.call(
        this,
        code,
        textState
      );
...
Window_Message.prototype.processEscapeCharacter = function (code, textState) {
  switch (code) {
    ...
    default:
      Yanfly.Message.Window_Message_processEscapeCharacter.call(
        this,
        code,
        textState
      );
